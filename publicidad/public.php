...
<body>
  <script>
      var direcciones = new Array( "public.html", "public2.html","public3.html", "public4.html", "public5.html", "public6.html")
      function enlaceAleatorio(){
         aleat = Math.random() * direcciones.length
         aleat = Math.floor(aleat)
         //window.location=direcciones[aleat]
         window.open(direcciones[aleat],"ventana1","width=1000,height=800,scrollbars=NO")
      }
  </script>
    ...
    <div class="container">
        <div class="col-md-6 col-sm-12">
            ...
            <div class="row">
                ...
                <div class="alert alert-info">
                  <a>Obtenga 30 minutos</a>
                  <button  class="boton" id="btnModal">GRATIS </button>
                </div>
